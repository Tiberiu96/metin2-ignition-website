...
@section('content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 class="text-lg font-bold uppercase tracking-widest text-center" style="color: var(--color-gold-400); margin-bottom: 4rem;">{{ __('contact_title') }}</h1>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="shrink-0 w-8 h-8 rounded flex items-center justify-center" style="background-color: var(--color-game-surface); border: 1px solid var(--color-game-border);">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: var(--color-gold-400)">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="shrink-0 w-8 h-8 rounded flex items-center justify-center" style="background-color: var(--color-game-surface); border: 1px solid var(--color-game-border);">
                            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor" style="color: var(--color-gold-400)">
